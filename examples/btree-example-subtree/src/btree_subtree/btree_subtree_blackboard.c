/**
 * @file btree_subtree_blackboard.c
...
/**
 * @brief Tree structure with relevant blackboard data subtree.
 * 
 */
struct btree_subtree_blackboard {
...
{
     memset(&btree_subtree_data, 0, sizeof(btree_subtree_data));
}
