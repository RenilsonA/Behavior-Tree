...
class ARCHIVE_CREATOR:
    ...
    def generate_blackboard_inc(self):
        ...
        self.text += "/**\n"
        self.text += f" * @brief Estrutura dos dados usado na árvore {self.project[:-1].lower()}.\n"
        self.text += " * \n"
        self.text += " */\n"
        self.text += f"struct {self.project.lower()}bt_blackboard\n"
        self.text += "{\n\n};\n\n"
        self.text += "/**\n"
        self.text += f" * @brief Estrutura com dados pertinentes da blackboard da árvore {self.project[:-1].lower()}.\n"
        self.text += " * \n"
        self.text += " */\n"
        self.text += f"extern struct {self.project.lower()}bt_blackboard {self.project.lower()}bt_data;\n\n"
        self.text += "/**\n"
        self.text += f" * @brief Limpa todos dados da blackboard {self.project[:-1].lower()}.\n"
        self.text += " * \n"
        self.text += " */\n"
        self.text += f"void {self.project.lower()}bt_reset_blackboard(void);\n\n"
    ...
    def generate_blackboard_src(self):
        ...
        self.text += f"void {self.project.lower()}bt_reset_blackboard(void)\n"
        self.text += "{\n"
        self.text += f"     memset(&{self.project.lower()}bt_data, 0, sizeof({self.project.lower()}bt_data));\n"
        self.text += "}\n"
